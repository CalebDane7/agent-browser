...
type Locator = any;
type CDPSession = any;
declare const devices: Record<string, any>;
...
/**
 * Manages the browser lifecycle via raw CDP with multiple tabs/windows
 */
export declare class BrowserManager {
     ...
     * (viewport size), not physical pixel dimensions (viewport × scale). This is a CDP emulation limitation
    ...
    isRecording(): boolean;
    /**
     * Start recording to a video file (not available in raw CDP mode).
